...
namespace ClaimsReimbursement.Infrastructure.Migrations
{
    ...
    [Migration("20240812053432_AddedBankEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaimsReimbursement.Infrastructure.Context.Entities.Bank", b =>
                {
                    b.Property<int>("BankId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            BankId = 1,
                            BankName = "Last International Bank"
                        },
                        new
                        {
                            BankId = 2,
            ...
            modelBuilder.Entity("ClaimsReimbursement.Infrastructure.Context.AppUser", b =>
                {
                    b.HasOne("ClaimsReimbursement.Infrastructure.Context.Entities.Bank", "Bank")
                        .WithMany("AppUsers")
